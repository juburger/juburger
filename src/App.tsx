...
import { TenantProvider, isSuperAdminDomain } from "@/contexts/TenantContext";
...
const AppRoutes = () => {
  // If on superadmin.siparis.co, only serve SuperAdmin panel
  ...
  return (
    <Routes>
      ...
      {/* Super admin only accessible via superadmin.siparis.co */}
